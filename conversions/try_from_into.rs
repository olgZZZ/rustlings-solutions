...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from((red, green, blue): (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        // match (red_res, green_res, blue_res) {
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        // let red_res = u8::try_from(red);
        // let green_res = u8::try_from(green);
        // let blue_res = u8::try_from(blue);
        let [red, green, blue] = arr.map(|v| u8::try_from(v));
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let array = <[i16; 3]>::try_from(slice).map_err(|_| IntoColorError::BadLen)?;
